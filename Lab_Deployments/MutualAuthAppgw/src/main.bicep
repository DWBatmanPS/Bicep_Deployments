...
param rewriteheadername string = 'Header'
param rewriteheadervalue string = 'Value'
...
module appgw '../../../modules/Microsoft.Network/Appgw_v2_rewrites.bicep' = {
  ...
  params: {
    ...
    isMutualAuth: isMutualAuth
    mutualauthcertname: mutualauthcertname
    mutualauthcertdata: mutualauthcertdata
    headername: rewriteheadername
    headervalue: rewriteheadervalue
    tagValues: {}
  }
  dependsOn: [
    virtualNetwork
