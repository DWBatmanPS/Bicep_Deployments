...
module AGC_Helm_Install '../../../modules/Microsoft.Resources/AGC_Helm_Deployment.Bicep' = {
  name: 'agc_helm_install'
  params: {
    aksName: aks_module.outputs.aks_cluster_name
    initialScriptDelay: '120s'
    DeployName: 'agc-controller'
    AGCVersion: AGCVersion
    ControllerNamespace: 'azure-alb-system'
    AGCClientID: managed_identity.outputs.clientID
